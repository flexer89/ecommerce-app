...
def test_get_shipment_by_order_success(mock_db_session, mock_get_shipment_by_order_id_db):
    shipment_response = {
        "id": 0,
        "order_id": 0,
        "user_id": "string",
...
def test_get_shipment_by_order_malformed_request(mock_db_session, mock_get_shipment_by_order_id_db):
