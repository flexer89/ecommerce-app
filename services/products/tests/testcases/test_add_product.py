...
def test_add_product_duplicate_name(mock_collection):
    ...
    # mock mongo collection
    mock_collection.insert_one.side_effect = DuplicateKeyError("Mocked duplicate key error")
...
def test_add_product_database_error(mock_collection):
    ...
    mock_collection.insert_one.side_effect = ConnectionError("Mocked database connection error")
