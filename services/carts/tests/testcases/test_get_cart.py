...
async def test_get_cart_success(mock_redis):
    ...
    cart_data = {'1:500:fine': '{"id": 1, "name": "Product 1", "price": 10.0, "discount": 0.0, "grind": "fine", "weight": 250.0, "quantity": 4}'}
    ...
    assert data["items"] == [
        {"id": 1, "name": "Product 1", "price": 10.0, "discount": 0.0, "grind": "fine", "weight": 250.0, "quantity": 4},
    ]
